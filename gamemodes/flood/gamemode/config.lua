...
VisibleTools = {
	"floodflag", "thruster", "weld", "smartwelder", "remover", "floodcannon", "floodmotor", "paint", "balloon", "rope", "camera", "trails", "colour", "light", "material", "specialprops"
}

-- What tools should be useable for everyone for everyround.
ToolsWhitelist = {
	"floodflag", "weld", "smartwelder", "remover", "floodmotor", "specialprops"
}
