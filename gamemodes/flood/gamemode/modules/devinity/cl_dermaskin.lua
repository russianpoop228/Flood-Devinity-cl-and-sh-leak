for i = 8, 40, 2 do
	surface.CreateFont("DevinityDerma" .. i,
	{
		font     = "Arimo",
		weight   = 500,
		size     = i,
...
SKIN.PrintName		= "Devinity Derma Skin"
SKIN.Author			= "Devinity"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/devinity.png" )
...
SKIN.fontCategoryHeader			= "DevinityDerma1"
