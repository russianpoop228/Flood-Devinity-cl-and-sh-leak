...
vgui.Register("FMWarningPopup", PANEL, "DFrame")

local warnmenu
net.Receive("FMOpenWarnPopup", function()
	if IsValid(warnmenu) then warnmenu:Remove() end

	local reason = net.ReadString()

	warnmenu = vgui.Create("FMWarningPopup")
		warnmenu:SetReason(reason)
end)
