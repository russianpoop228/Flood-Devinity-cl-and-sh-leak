...
SWEP.ViewModel     = Model("models/weapons/tfa_nmrih/v_exp_molotov.mdl")
SWEP.ViewModelFOV  = 50
SWEP.WorldModel    = Model("models/weapons/tfa_nmrih/w_exp_molotov.mdl")
SWEP.UseHands      = true

SWEP.ThrowStrength = 1.3

SWEP.WepSelectIcon = Material( "vgui/entities/weapon_molotov.png" )

function SWEP:SpawnGrenade()
	local ent = ents.Create("fm_incendiary")
	return ent
end
