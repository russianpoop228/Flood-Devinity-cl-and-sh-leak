...
function SWEP:GetEntityByName(name)
	if self.VElements[name] then
		return self.VElements[name].modelEnt
	end
...
function SWEP:SWEPKitInit()
-- Create a new table for every weapon instance
	self.VElements = table.FullCopy( self.SWEPKitVElements )
