...
if CLIENT then
	CreateClientConVar("fm_drawlights", 1, true, false)
	AddSettingsItem("quality", "checkbox", "fm_drawlights", {lbl = "Draw Lights"})
end

function ENT:Initialize()

	if CLIENT and GetConVar("fm_drawlights"):GetBool() then
...
function ENT:DrawTranslucent()
	...
	if not GetConVar("fm_drawlights"):GetBool() or not self.PixVis then return end
