...
-- SWEP Construction Maker Entity WElements
...
ENT.SWEPKitWElements = {
    ["rpga1"] = { type = "Model", model = "models/props_wasteland/coolingtank02.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 0), angle = Angle(270, 0, 0), size = Vector(0.129, 0.129, 0.150), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/bomb", skin = 0, bodygroup = {} }
}
