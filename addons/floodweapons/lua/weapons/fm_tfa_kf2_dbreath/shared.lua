...
SWEP.Category				= "TFA Left 4 Dead 2" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = "Winchester" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "KF2 Dragon's Breath M97"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_L4D2_KF2_DBREATH.1")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= nil				-- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage		= 12					-- Damage, in standard damage points.
SWEP.Primary.HullSize = 0 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
SWEP.DamageType = bit.bor(DMG_BURN,DMG_BULLET)--See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.Primary.SpreadRecovery = 1.4 --How much the spread recovers, per second.

--Range Related
SWEP.Primary.Range = 65.6168*16 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_kf2_dbreath.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_kf2_dbreath.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(-10.813, 15.454, -6.294)
--[[IRONSIGHTS]]--
...
SWEP.IronSightsPos = Vector(-3.06, -4.791, 2.318)
SWEP.IronSightsAng = Vector(-0.879, 0.813, 0)
--[[INSPECTION]]--

SWEP.InspectPos = Vector(6.019, -6.312, -3)
SWEP.InspectAng = Vector(31.611, 45.441, 11.899)
...
SWEP.BlowbackVector = Vector(0,-3,0.2) --Vector to move bone <or root> relative to bone <or view> orientation.
SWEP.BlowbackCurrentRoot = 0 --Amount of blowback currently, for root
SWEP.BlowbackCurrent = 0 --Amount of blowback currently, for bones
SWEP.Blowback_Only_Iron = true --Only do blowback on ironsights
SWEP.Blowback_PistolMode = true --Do we recover from blowback when empty?
SWEP.Blowback_Shell_Enabled = true
SWEP.Blowback_Shell_Effect = "EjectBrass_12Gauge"
...
SWEP.SequenceLengthOverride={
	--[ACT_VM_HITCENTER] = 1.0,
	--[ACT_VM_RELOAD] = 2.0,
	--[ACT_VM_RELOAD_EMPTY] = 2.3,
	--[ACT_VM_DRAW] = 1.5,
	--[ACT_VM_DRAW_EMPTY] = 1.5
    [ACT_SHOTGUN_RELOAD_FINISH] = 0.8
...
SWEP.LuaShellEjectDelay = 0.41666666666
