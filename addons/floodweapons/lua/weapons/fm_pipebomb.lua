SWEP.PrintName = "'Delta' Hand Grenade"
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		local ent = ents.Create ( "fm_pipefrag" ) -- This is our entity (yay!) and where most of the explosive code will be located at
		...
		fragthrow:SetVelocity ( self.Owner:GetAimVector():GetNormalized() * 1000 ) -- This is our new velocity from fm_grenadelauncher. You can set how far the grenade entity travels. 1250 is the closest I can get for it to replicate the HL2's grenade
		...
		if self:Clip1() == 0 and self:Ammo1() == 0 then
			timer.Simple(2.5, function()
				...
				self.Owner:StripWeapon("fm_pipebomb")
...
-- Hand Grenade VElements (courtesy of Lime)
SWEP.VElements = {
