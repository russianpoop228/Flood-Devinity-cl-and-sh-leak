if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_ak12")
end
SWEP.Base							= "tfa_gun_base"								-- Swep base
SWEP.Category						= "TFA KF2 Remake" 								-- The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.Primary.SoundTable[2]=snd2
SWEP.Primary.SoundTable[3]=snd3
...
SWEP.Primary.RPM_Semi 				= 620 											-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.Ammo 					= "kf2r_rifle" 									-- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_ak12.mdl"			-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.6, 3, -1.6)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_ak12.mdl" 			-- Weapon world model path
...
SWEP.HoldType = "shotgun" 
																-- This is how others view you carrying the weapon. Options include: normal melee melee2 fist knife smg ar2 pistol rpg physgun grenade shotgun crossbow slam passive. You're mostly going to use ar2, smg, shotgun or pistol. rpg and crossbow make for good sniper rifles
SWEP.Offset = {
        Pos = {
        Up = -4.8,
        Right = 1,
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(4, -.6, -1) 							-- Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng 					= Vector(-13.4, 30, -7.7) 						-- Change this, using SWEP Creation Kit preferably
...
--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(14, 2.8, -1)
...
--Tracer Stuff	
SWEP.TracerName 					= "tfa_bt_assault" 								-- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
