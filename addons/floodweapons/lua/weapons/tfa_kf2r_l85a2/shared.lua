if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_l85a2")
end
...
SWEP.Manufacturer 					= "HK" 											-- Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.Purpose						= "The SA80 was the British Army's standard weapon before the Army was, well, eaten." 											-- Purpose Tooltip
SWEP.Instructions					= "Choice of full-auto and semi-auto fire modes. Alt-fire to toggle between fire modes." 											-- Instructions Tooltip
SWEP.Spawnable						= true 											-- Can you, as a normal user, spawn this?
SWEP.AdminSpawnable					= true 											-- Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair					= true										-- Draw the crosshair?
SWEP.DrawCrosshairIS 				= false 										-- Draw the crosshair in ironsights?
SWEP.PrintName						= "L85A2 SA80 Rifle"										-- Weapon name (Shown on HUD)	
...
--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_L85A2.1")
...
SWEP.Primary.RPM 					= 680 											-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi 				= 1100 											-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.StaticRecoilFactor 	= 2.1											-- Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
--Misc
SWEP.IronRecoilMultiplier			= 0.55 											-- Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
SWEP.SprintBobMult=4.0 -- More is more bobbing, proportionally.  This is multiplication, not addition.  You want to make this > 1 probably for sprinting.
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_l85a2.mdl"				-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(3.5, 2.0, -0.7)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_l85a2.mdl" 				-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(4.2, -2.0, -4) 							-- Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng 					= Vector(-20, 40, -50)					-- Change this, using SWEP Creation Kit preferably
...
--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(13, 0.0, -1)
...
--Tracer Stuff	
SWEP.TracerName 					= "tfa_regfiretrail" 											-- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
