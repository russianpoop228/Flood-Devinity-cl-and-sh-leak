...
SWEP.PrintName				= "Star Chaser AR"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("StarAR.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Spread		= .018					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_starchaserar.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_starchaserar.mdl" -- Worldmodel path
...
SWEP.Secondary.IronFOV			= 45					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(7.802, -5.099, 1.32)
SWEP.IronSightsAng = Vector(-2.796, 1.095, -5.718)
...
SWEP.TracerName 		= "tfa_tracer_gauss" 	--Change to a string of your tracer name.  Can be custom.
