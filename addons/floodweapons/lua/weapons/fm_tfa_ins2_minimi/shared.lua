...
SWEP.PrintName				= "Minimi Para"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_MINIMI.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_MINIMI.2") -- This is the sound of the weapon, when silenced.
...
--Range Related
SWEP.Primary.Range = 29527.6 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_minimi.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 56		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(2.5,6.5,-0.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_minimi.mdl" -- Weapon world model path
...
SWEP.Secondary.IronFOV = 79 -- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
SWEP.IronSightsPos = Vector(-2.681, -2.113, 1.125)
...
SWEP.StatusLengthOverride = {
	[ACT_VM_RELOAD] = 154 / 31.5,
	[ACT_VM_RELOAD_EMPTY] = 223 / 31.5,
	[ACT_VM_RELOAD_DEPLOYED] = 185 / 31.5
...
SWEP.ScopeDistanceRange_PO4X = 10
SWEP.ScopeDistanceMin_PO4X = 9

DEFINE_BASECLASS( SWEP.Base ) -- вот уже где начинается реальный изврат -- oh i mean cool bodygroup thing ... hehe .. .
