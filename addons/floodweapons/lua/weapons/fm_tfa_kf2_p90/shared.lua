...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_ROCKY_KF2_P90.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip			= 200					-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Range Related
SWEP.Primary.Range = 200*3*16 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_kf2_p90.mdl" --Viewmodel path
...
SWEP.VMPos = Vector(1,2,0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_kf2_p90.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.961, -13.141, -0.017)
SWEP.IronSightsAng = Vector(0.18, 0.25, 0)
...
SWEP.BlowbackVector = Vector(0.0,-2.5,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.RTMaterialOverride = 6 -- Take the material you want out of
