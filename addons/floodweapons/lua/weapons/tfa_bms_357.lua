...
SWEP.PrintName				= "357 Magnum"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_357_bms.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip = 66 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_bms/c_bms_357.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-2.77, -0.5, 1.52)
SWEP.IronSightsAng = Vector(0, 0, 0.703)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(4.75, -1.81, 2.159) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(0, 28.843, 11.1) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.BlowbackVector = Vector(-0,-4,0.05) --Vector to move bone <or root> relative to bone <or view> orientation.
