if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_scar")
end
...
SWEP.Purpose						= "Designed originally for the US Special Operations Command, it is, indeed, special!" 											-- Purpose Tooltip
...
SWEP.PrintName						= "SCAR-H Assault Rifle"										-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_SCAR.1")
...
SWEP.Primary.DefaultClip 			= 360 											-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.CrouchAccuracyMultiplier 		= 0.0 											-- Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_scar.mdl"				-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.0, 5.0, -1.5)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_scar.mdl" 			-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(8.6, -10, 2.0) 							-- Change this, using SWEP Creation Kit preferably
...
SWEP.SequenceRateOverrideScaled = {
    [ACT_VM_PRIMARYATTACK] = 3.5,
	[ACT_VM_PRIMARYATTACK_EMPTY] = 3.5
}	
