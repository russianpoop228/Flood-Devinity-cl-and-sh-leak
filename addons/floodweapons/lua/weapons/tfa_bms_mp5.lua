...
SWEP.Type = "9mm SMG with Underbarrel Grenade Launcher (+ZOOM KEY TO TOGGLE)"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_mp5_bms.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Scoped = 570 -- This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.BaseKick = 0.1 -- This is the maximum upwards recoil (rise)
SWEP.Primary.MaxKick = 0.2 -- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.SpreadRecovery = 2.75 --How much the spread recovers, per second. Example val: 3
--Range Related
...
SWEP.VMAng = Vector(0,00,0) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
...
SWEP.IronSightsPos_EOTech = Vector(-3.62, -2.5, 1.0)
SWEP.IronSightsAng_EOTech = Vector(1, -1.15, 0)
--[[INSPECTION]]--
...
SWEP.Idle_Blend = 0.15 --Start an idle this far early into the end of a transition
SWEP.Idle_Smooth = 0.05 --Start an idle this far early into the end of another animation
SWEP.SprintBobMult = 0.5 -- More is more bobbing, proportionally.  This is multiplication, not addition.  You want to make this > 1 probably for sprinting.
...
if killicon and killicon.Add then
    killicon.Add("tfa_bms_mp5", "bms/vgui/icons/tfa_bms_mp5", hudcolor)
end

function SWEP:Deploy( ... )

	if self:Ammo2() > 0 and self.Owner:Alive() then
			self.Owner:Hint("You have "..self:Ammo2().." grenades left in your launcher.", "information")
			self.Owner:Hint("Press 'E + Right Click' to use it!", "information")
		else	
	end
...
SWEP.Secondary.Sound = Sound("weapons/mp5/double.wav")
