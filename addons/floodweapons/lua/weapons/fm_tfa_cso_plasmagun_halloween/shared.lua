...
--Firing related
SWEP.Primary.Sound 			= Sound("PlasmaGun.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 55					-- Damage, in standard damage points.
--SWEP.DamageType = bit.bor(DMG_ACID,DMG_AIRBOAT,DMG_BLAST,DMG_ALWAYSGIB) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.NZPaPName				= "Face-Melter 4000"
SWEP.NZPaPReplacement 	= "tfa_cso_plasmagun_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 225				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Range Related
SWEP.Primary.Range = 9999 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_plasmagun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_plasmagun.mdl" -- Weapon world model path
...
SWEP.Secondary.IronFOV			= 20					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(7.21, -4.874, 2.165)
...
SWEP.MuzzleFlashEffect = "cso_muz_plasgun" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_plasgun" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:ShootBulletInformation()
	...
	basedamage = ISHALLOWEEN and self:GetStat("Primary.Damage") * 1.25 or self:GetStat("Primary.Damage")
