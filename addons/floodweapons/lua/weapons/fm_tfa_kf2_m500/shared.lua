...
SWEP.PrintName				= "S&W M500"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_L4D2_SW_500.1")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= nil				-- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage		= 80					-- Damage, in standard damage points.
SWEP.Primary.HullSize = 2 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
...
--Range Related
SWEP.Primary.Range = 164.042*16 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 0.6 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
...
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_sw_m500.mdl" --Viewmodel path
...
SWEP.CameraOffset = Angle(0.05,-2.3,-1.2)
...
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_sw_m500.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.927, -4.257, 1.44)
SWEP.IronSightsAng = Vector(-0.05, -1.075, 0)
--[[INSPECTION]]--
...
SWEP.SequenceLengthOverride={
	[ACT_VM_HITCENTER] = 1.5,
	[ACT_VM_RELOAD] = 3.5,
	[ACT_VM_RELOAD_EMPTY] = 3.8
...
SWEP.Tracer				= 1	--Bullet tracer.  TracerName overrides this.
