...
SWEP.PrintName				= "GOL Magnum"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage = 140-- Damage, in standard damage points.
...
SWEP.Primary.RPM_Displayed = math.Round( 60 / 1.2 ) -- This is in Rounds Per Minute / RPM
...
SWEP.VMPos = Vector(1,4,0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
