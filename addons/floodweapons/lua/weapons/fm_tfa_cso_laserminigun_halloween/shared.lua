...
SWEP.PrintName				= "Laser Minigun"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("Laserminigun.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi				= 1200					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Gatling Laser"
...
SWEP.Primary.ClipSize			= 200					-- This is the size of a clip
...
--Recoil Related
SWEP.Primary.KickUp			= 0.20 				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_laserminigun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_laserminigun.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_lsr_mg" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_lsr_mg" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("Laserminigun.Idle")
	return BaseClass.Holster(self,...)
end

SWEP.ViewModelBoneMods = {
	["Bone25"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["Bone26"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 35.251, 0) }
}
