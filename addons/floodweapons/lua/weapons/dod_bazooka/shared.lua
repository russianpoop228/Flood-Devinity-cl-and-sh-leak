...
SWEP.Manufacturer = "Memes" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Asymmetrical Footwear" --Author Tooltip
...
SWEP.PrintName				= "M1 Bazooka"		-- Weapon name (Shown on HUD)
...
SWEP.Type = "Recoilless rocket anti-tank weapon"
...
SWEP.Primary.PenetrationMultiplier = 0.81 --Change the amount of something this gun can penetrate through
...
SWEP.ProjectileVelocity = 1250 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/w_bazooka_rocket.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/c_dod_bazooka.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/w_bazooka.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.8, 0, -0.4)
SWEP.IronSightsAng = Vector(0.6, -0.4, 0)

--[[INSPECTION]]--

SWEP.InspectPos = Vector(5,0,-3) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(0,45,-25) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.BlowbackVector = Vector(0,-10,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.MuzzleFlashEffect = "tfa_muzzleflash_incendiary" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
