...
SWEP.PrintName				= "Star Chaser SR"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("StarChaserSR.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 400					-- Damage, in standard damage points.
SWEP.DamageType = bit.bor(DMG_BULLET,DMG_DISSOLVE) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.Primary.DefaultClip			= 165				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_starchasersr.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_starchasersr.mdl" -- Weapon world model path
...
SWEP.Secondary.IronFOV			= 19					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(10.397, -9.219, 1.873)
...
SWEP.MuzzleFlashEffect = "cso_muz_scsr" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_scsr" 	--Change to a string of your tracer name.  Can be custom.
