...
SWEP.PrintName				= "Lightning Rail"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Damage		= 300					-- Damage, in standard damage points.
SWEP.DamageType = DMG_BULLET --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic			= true				-- Automatic/Semi Auto
SWEP.Primary.RPM				= 25					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 25					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.KickDown			= 0.275					-- This is the maximum downwards recoil (skeet)
...
SWEP.ProjectileVelocity = 1624 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/sov_grenade.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_lightning_rail.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_lightning_rail.mdl" -- Weapon world model path
...
SWEP.Secondary.IronFOV			= 24					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(7.212, -3.109, 1.309)
...
SWEP.TracerName 		= "cso_tra_light_rail" 	--Change to a string of your tracer name.  Can be custom.
