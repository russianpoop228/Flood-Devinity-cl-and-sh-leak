...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_tmp.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 29 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = true -- Automatic/Semi Auto
SWEP.Primary.RPM = 2000 -- This is in Rounds Per Minute / RPM

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "That Machine Pistol"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_tmp.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_tmp.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(-1, -4, 0)
SWEP.RunSightsAng = Vector(-11.869, -25.129, 16.056)
...
SWEP.IronSightsPos = Vector(4.619, -4.215, 3.519)
SWEP.IronSightsAng = Vector(0, 1.129, -4.045)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(4.559, -6.821, 3.519) -  SWEP.IronSightsPos --Vector to move bone <or root> relative to bone <or view> orientation.
