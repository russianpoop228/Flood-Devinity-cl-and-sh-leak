...
EFFECT.Col1 = Color(255,140,100) --Color(225,225,225,225)
EFFECT.Col2 = Color(255,255,255)
EFFECT.Speed = 8000
EFFECT.TracerLength = 500
...
render.DrawBeam(startbeampos, endbeampos, 5.0, 0, 1, lerpedcol)
end
