...
local color1 = Color( 253, 207, 70, 255 )
local color2 = Color( 151, 108, 3, 255 )
...
function EFFECT:Init(data)
	...
	if (sparticle) then
		...
		sparticle:SetColor(255, 106, 106)
